...
/**
 * Created by kushaldileep on 7/7/2016.
 */
public class swipablerecyclerview implements RecyclerView.OnItemTouchListener {
    private int mSlop;
     ...
     */
    public swipablerecyclerview(RecyclerView recyclerView, SwipeListener listener) {
